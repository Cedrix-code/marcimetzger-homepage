...
export default function Services() {
  ...
  const services = [
    {
      ...
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <title>Capital Raising Icon</title>
    ...
    },
    {
      ...
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <title>Investor Experience Icon</title>
    ...
    },
    {
      ...
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <title>Investment Management Icon</title>
    ...
    },
    {
      ...
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <title>Tax and Bookkeeping Icon</title>
  ...
  return (
    <section ref={servicesRef} className="py-24 section" style={{ backgroundColor: '#F1EBE2' }}>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {services.map((service, index) => (
            <motion.div
              ...
              className="service-card rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow"
              style={{ backgroundColor: '#F1EBE2' }}
            >
              <div className="mb-6">{service.icon}</div>
              <h3 className="text-2xl font-bold mb-4 text-blue-900">{service.title}</h3>
              <p className="text-gray-600 mb-6">{service.description}</p>
              <a href="#contact" className="text-blue-600 font-semibold hover:text-blue-800 transition-colors inline-flex items-center">
                Read more
