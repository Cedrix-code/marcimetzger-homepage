        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-6">
              ...
              >
                <a href="https://facebook.com/marcimetzger" className="text-blue-600 hover:text-blue-800" aria-label="Visit Marci Metzger on Facebook">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <title>Facebook Icon</title>
                    <path d="M18.77 7.46H14.5v-1.9c0-.9.6-1.1 1-1.1h3V.5h-4.33C10.24.5 9.5 3.44 9.5 5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4z" />
                  </svg>
                </a>
                <a href="https://instagram.com/marcimetzger" className="text-blue-600 hover:text-blue-800" aria-label="Visit Marci Metzger on Instagram">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="https://linkedin.com/in/marcimetzger" className="text-blue-600 hover:text-blue-800" aria-label="Visit Marci Metzger on LinkedIn">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          >
            <form className="p-8 rounded-lg shadow-lg" style={{ backgroundColor: '#F1EBE2' }}>
              <div className="mb-6">
              ...
              <div className="mb-6">
                ...
                <textarea className="w-full px-4 py-3 border border-gray-300 rounded-md h-32 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500" id="message" />
              </div>
              
              <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-md shadow-md transition-colors">
                Send Message
              </button>
            </form>
          </motion.div>
